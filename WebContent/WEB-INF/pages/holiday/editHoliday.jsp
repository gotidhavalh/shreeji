							...
							<div class="col-12 heading py-2 my-2 mb-4 border-bottom">
								...
								<div class="form-group">
									...
									<div class="input-group date">
										<input type="text" class="form-control" id="datetimepicker4" aria-describedby="inputGroupPrepend3" name="date" value="${list.date}"> 
							...
							<div class="col-12">
								<div class="form-group">
									<label for="code" class="d-block text-left">Holiday	Name</label> 
										<input class="form-control" type="text" id="code" name="holiName" value="${list.holiDayName}">
								</div>
							</div>
						</div>
						<div class="col-12 text-right mt-3">
							<input type="hidden" name="action" value="editHolidays"> 
